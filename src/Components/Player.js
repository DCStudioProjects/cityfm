...
export default class Player extends Component {
    ...
    async componentDidMount() {
        ...
        this.setState({ data });
        console.log(data);
        const images = await fetch("http://ws.audioscrobbler.com/2.0/?method=album.getInfo&artist=" + this.state.data?.artist.name + "&album=" + (this.state.data?.album || this.state.data?.title) + "&api_key=ac93b58817c64de67582b6350184ca24&format=json") || "1";
